...
public interface PermissaoService
{
	...
	public List<Permissao> listarPermissoesByAreaUsuario() throws Exception;
	public List<Permissao> listarPermissoesByAreaObservadores() throws Exception;
	public List<Permissao> listarPermissoesByAreaTecnicos() throws Exception;
	public List<Permissao> listarPermissoesByAreaAdministradores() throws Exception;
